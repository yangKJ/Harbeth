...
public struct C7WhiteBalance: C7FilterProtocol {
    ...
    public static let range: ParameterRange<Float, Self> = .init(min: 4000, max: 8000, value: 5000)
    ...
    /// The temperature to adjust the image by, in ºK. A value of 4000 is very cool and 8000 very warm.
    /// Note that the scale between 4000 and 5000 is nearly as visually significant as that between 5000 and 8000.
