...
public struct C7FalseColor: C7FilterProtocol {
    ...
    public var kernelParameterBindings: [KernelParameterBinding] {
        [
            KernelParameterBinding(name: "fristColor", index: 0, stage: .compute, value: .float3(fristColor.c7.toSIMD3())),
            KernelParameterBinding(name: "secondColor", index: 1, stage: .compute, value: .float3(secondColor.c7.toSIMD3()))
        ]
    }
