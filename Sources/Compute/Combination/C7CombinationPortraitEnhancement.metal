...
kernel void C7CombinationPortraitEnhancement(texture2d<half, access::write> outputTexture [[texture(0)]],
                                             texture2d<half, access::read> inputTexture [[texture(1)]],
                                             texture2d<half, access::read> processedTexture [[texture(2)]],
                                             constant float *intensity [[buffer(0)]],
                                             constant float *skinTone [[buffer(1)]],
                                             constant float *eyeEnhancement [[buffer(2)]],
                                             constant float *teethWhitening [[buffer(3)]],
