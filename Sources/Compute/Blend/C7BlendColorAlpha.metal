...
kernel void C7BlendColorAlpha(texture2d<half, access::write> outputTexture [[texture(0)]],
    ...
    const half4 outColor(mix(inColor.rgb, overlay.rgb, overlay.a * half(*mixturePercent)), inColor.a);
