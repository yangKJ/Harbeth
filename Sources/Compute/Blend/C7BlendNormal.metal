...
kernel void C7BlendNormal(texture2d<half, access::write> outputTexture [[texture(0)]],
    ...
    half4 outColor;
    outColor.rgb = overlay.rgb + inColor.rgb * inColor.a * (1 - overlay.a);
    outColor.a = overlay.a + inColor.a * (1 - overlay.a);
