...
Harbeth 对普通调用方只有两条主路线：`HarbethIO` 用于直接处理，`ImageNode` 用于高级统一编辑与结果合同。Runtime、Analysis、Recipe 和 Preview Host 都是支撑层。下面按问题选择文档，不需要从 runtime 目录开始阅读。
...
| 理解源码目录与两条路线的映射 | [能力地图](CAPABILITY_MAP_CN.md) |
...
- [输入输出互操作](../Sources/Harbeth.docc/InputOutputInterop.md)
- [输出合同](../Sources/Harbeth.docc/OutputContracts.md)
- [Preview Hosting](../Sources/Harbeth.docc/PreviewHost.md)
- [实时交付](../Sources/Harbeth.docc/RealTimeDelivery.md)
- [Filter Authoring](../Sources/Harbeth.docc/FilterAuthoring.md)
